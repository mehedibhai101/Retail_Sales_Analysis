...
**PowerQuery M Code regarding data preparation process of the sales table can be found [[here]](https://github.com/mehedibhai101/Retail_Sales_Analysis/blob/main/data_cleaning.m).**
